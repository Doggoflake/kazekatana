...
public class AppakuTataraFurnaceScreen extends AbstractContainerScreen<AppakuTataraFurnaceMenu> {
    ...
    private static final ResourceLocation HEATBAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(KazeKatana.MOD_ID, "textures/gui/tatarafurnace/appakutatarafurnacebaseheatbar.png");
    ...
    public AppakuTataraFurnaceScreen(AppakuTataraFurnaceMenu menu, Inventory inv, Component title) {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        // Title
        guiGraphics.drawString(this.font, "Appaku Tatara Furnace", 36, 6, 0x404040, false);
