...
public class AppakuTataraFurnaceMenu extends AbstractContainerMenu {
    public final AppakuTataraFurnaceBlockEntity blockEntity;
    ...
    public AppakuTataraFurnaceMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(5));
    }

    public AppakuTataraFurnaceMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.APPAKU_TATARA_FURNACE_MENU.get(), pContainerId);
        this.blockEntity = (AppakuTataraFurnaceBlockEntity) entity;
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(itemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(itemHandler, TE_SLOT_INPUT, 44, 30) {
                ...
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return stack.is(ModBlocks.CRIMSON_CORE.get().asItem());
                }
            });
            ...
            this.addSlot(new SlotItemHandler(itemHandler, TE_SLOT_FUEL, 80, 57) {
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return stack.is(ModItems.INFERNAL_KORU.get()) || ForgeHooks.getBurnTime(stack, null) > 0;
                }
            });
            ...
            this.addSlot(new SlotItemHandler(itemHandler, TE_SLOT_MODU, 152, 57) {
                ...
                public boolean mayPlace(@NotNull ItemStack stack) {
                    ...
                    return stack.is(ModItems.CARDINAL_KOSHIRAE.get());
                }
            });
        });
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (index < TE_INVENTORY_FIRST_SLOT_INDEX) {
            ...
            if (sourceStack.is(ModBlocks.CRIMSON_CORE.get().asItem())) {
            ...
            } else if (sourceStack.is(ModItems.INFERNAL_KORU.get()) || ForgeHooks.getBurnTime(sourceStack, null) > 0) {
                if (!moveItemStackTo(sourceStack, TE_INVENTORY_FIRST_SLOT_INDEX + TE_SLOT_FUEL, TE_INVENTORY_FIRST_SLOT_INDEX + TE_SLOT_FUEL + 1, false))
                    return ItemStack.EMPTY;
            } else if (sourceStack.is(ModItems.CARDINAL_KOSHIRAE.get())) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.APPAKU_TATARA_FURNACE.get());
    }
